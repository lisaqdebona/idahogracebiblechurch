...
Idaho Grace WordPress Theme, Copyright 2019-2020 WordPress.org
Idaho Grace is distributed under the terms of the GNU GPL.
...
Idaho Grace is derived from the Chaplin Theme, Copyright 2019 Anders Norén
Chaplin Theme is distributed under the terms of the GNU GPL version 2.0

Idaho Grace bundles the following third-party resources:
...
Bespoke Icons Created For Idaho Grace
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
- idahograce_SVG_Icons
- idahograce_the_theme_svg()
- idahograce_get_theme_svg()
- idahograce_nav_menu_social_icons()
