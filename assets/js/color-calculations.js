 ...
 * @return {Object} - this
 */
function _idahograceColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_idahograceColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_idahograceColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_idahograceColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _idahograceColor object.
 *
 * @since Idaho Grace 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function idahograceColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _idahograceColor( backgroundColor, accentHue );
